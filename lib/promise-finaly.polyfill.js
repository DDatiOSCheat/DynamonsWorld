...
if (typeof Promise.prototype.finally !== 'function') {
	...
	var shim = {
			...
			return Promise.prototype.then.call(
				promise,
				function(x) { return new C(function(resolve) { return resolve(onFinally()); }).then(function() { return x; }); },
				function(e) { return new C(function(resolve) { return resolve(onFinally()); }).then(function() { throw e;  }); }
			);
		}
	};
